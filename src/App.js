...
import { TweenMax, TweenLite, TimelineMax, Back } from 'gsap';
...
function App() {
  ...
  useEffect(() => {
    ...
    let brandTween = TweenMax.fromTo(
      '#brand-tween', 
      3, 
    ...
    let brandTween1 = TweenMax.fromTo(
      '#brand-tween1', 
      5, 
    ...
    let brandTween2 = TweenMax.fromTo(
      '#brand-tween2', 
      5, 
        ...
        <div className="row">
          <div id="hero" className="header-text">
            <div className="main-header">
              We are a group of independent designers and developers focused on creating outstanding
            </div>
          </div>
          ...
          <div 
              ...
              ></div>
              <div id="brand-tween1" className="tween"></div>
              <div id="brand-tween2" className="tween"></div>
            <div id="brand-pin">
              <BrandIdentities />
            </div>
          </div>
